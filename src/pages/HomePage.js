...
export default function HomePage() {
    const [activeCategory, setActiveCategory] = useState('Приложения', 'Разработка сайтов', 'Разработка игр');
    ...
    const handleClick2 = () => {
        navigate("/profile"); // укажи нужный путь
    }
        ...
        <div className="home-container">
            <button onClick={handleClick2} className="profile_button">
                <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <ellipse cx="13" cy="6.49996" rx="4.33333" ry="4.33333" fill="white"/>
                    <path d="M21.6666 18.9584C21.6666 21.6508 21.6666 23.8334 13 23.8334C4.33331 23.8334 4.33331 21.6508 4.33331 18.9584C4.33331 16.266 8.21351 14.0834 13 14.0834C17.7864 14.0834 21.6666 16.266 21.6666 18.9584Z" fill="white"/>
                </svg>
            </button>
            <img src={main_image} alt=""/>
            <div className="info-box">
                <h3>Создайте приложение под <br/>
                    ваши задачи</h3>
                <p>Выберите тип, добавьте функции и <br/>
                    настройте под ваш бренд. Мы позаботимся о <br/>
                    простоте разработки и успешном запуске!</p>
                    ...
                    {categories.map((category) => (
                        <button
                            ...
                            style={{
                                ...
                                border: 'none',
                                cursor: 'pointer',
                                backgroundColor: activeCategory === category ? '#7B61FF' : '#FFFFFF',
                ...
                <div style={{
                    ...
                    {data[activeCategory].map((item, index) => (
                        <div key={index} style={{
                            ...
                            />
                            <p style={{ marginTop: '12px', fontSize: '16px', fontWeight: 500 }}>{item.title}</p>
                        </div>
                    ))}
                </div>
            </div>
            <div className="w-full max-w-[680px] p-6 rounded-2xl bg-gradient-to-r from-[#E0D8FF] to-[#EAE4FF] flex justify-between items-center relative overflow-hidden shadow-md">
                <div className="home-partners">
                    <div className="left-partners">
                        ...
                        <p>Вы можете обратиться не <br/>
                            только к нам, но ещё и к <br/>
                            нашим партнёрам</p>
                    </div>
                    <div className="right-partners">
                        <img
                            src={img_partners} // путь к изображению (замени на свой)
