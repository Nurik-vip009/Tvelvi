    ...
    return (
        <div className="p-4">
            <div className="name_page">
                <h1 onClick={handleClick} className="text-xl font-semibold"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15 5L9 12L15 19" stroke="#0D0D0D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                    Наши партнёры</h1>
            </div>
